...
@JsonPropertyOrder({
  ...
  CreatePdfRequest.JSON_PROPERTY_PDF_VARIANT,
  CreatePdfRequest.JSON_PROPERTY_VERSION
})
...
public class CreatePdfRequest {
  ...
  public CreatePdfRequest pdfVariant(@jakarta.annotation.Nullable PdfVariant pdfVariant) {
  ...
  public CreatePdfRequest version(@jakarta.annotation.Nullable String version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.templateId, createPdfRequest.templateId) &&
        ...
        equalsNullable(this.pdfVariant, createPdfRequest.pdfVariant) &&
        equalsNullable(this.version, createPdfRequest.version);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(templateId, data, exportType, expiration, hashCodeNullable(filename), storeS3, hashCodeNullable(s3Filepath), hashCodeNullable(s3Bucket), hashCodeNullable(pdfVariant), hashCodeNullable(version));
  }
