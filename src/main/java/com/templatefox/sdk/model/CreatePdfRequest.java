...
public class CreatePdfRequest {
  ...
  private ExportType exportType = ExportType.URL;
  ...
  public CreatePdfRequest exportType(@jakarta.annotation.Nullable ExportType exportType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EXPORT_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExportType(@jakarta.annotation.Nullable ExportType exportType) {
    this.exportType = exportType;
  }
