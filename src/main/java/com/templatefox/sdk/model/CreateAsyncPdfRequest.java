...
public class CreateAsyncPdfRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(templateId, data, exportType, expiration, hashCodeNullable(filename), storeS3, hashCodeNullable(s3Filepath), hashCodeNullable(s3Bucket), hashCodeNullable(webhookUrl), hashCodeNullable(webhookSecret), hashCodeNullable(pdfVariant));
  }
